...
[Alpine](https://alpinelinux.org/)'s base image (v3.12.5 and v3.13.3) with [S6 overlay](https://github.com/just-containers/s6-overlay) pre-installed (version 2.2.0.3).
